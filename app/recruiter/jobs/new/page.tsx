...
export default function CreateJobPage() {
      ...
      try {
        ...
        if (res.ok) {
          ...
          if (data.Company) {
            ...
            // ✅ Auto-populate location from company if not set
  ...
  // ✅ Generate unique slug with timestamp + random
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const payload = {
        ...form,
        slug,
        companyId: company?.id, // ✅ Send company ID
      ...
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Add a job post that will appear on your job board.
            </p>
          </div>
        ...
        {Object.keys(errors).length > 0 && (
          <div className="mb-6 border border-red-200 bg-red-50 text-red-700 text-sm rounded-lg px-4 py-3">
            Please fill in all required fields before creating the job (
                ...
                {company ? (
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    <p className="text-sm text-yellow-800">
                      No company associated with your account. Please create a
                      company first.
                    </p>
                  </div>
                )}
