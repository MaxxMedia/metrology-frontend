...
export default function CandidateLinkedInProfile({ username }: Props) {
  ...
  if (loading) {
    return (
      <div className="bg-[#1D2125] min-h-screen flex items-center justify-center">
        <div className="text-center">
          <div className="w-12 h-12 border-4 border-[#0073ff] border-t-transparent rounded-full animate-spin mx-auto" />
          <p className="mt-4 text-[#a1a1a1] font-medium text-sm">Loading candidate profile...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="bg-[#1D2125] min-h-screen text-white relative">
      {/* Toast Notification */}
      {toastMessage && (
      ...
      <div className="max-w-[1180px] mx-auto px-4 pt-20 sm:pt-24 pb-16">
        ...
        <div className="bg-[#121213] rounded-xl border border-white/10 shadow-sm mb-4">
